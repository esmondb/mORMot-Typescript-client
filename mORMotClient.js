...
(function (mORMot) {
    ...
    var Client = (function () {
        function Client() {
            ...
            this.RetryLogin = true; // used in case of login timeout 403
            this.GET_HTTP_VERB = 'GET';
            this.PUT_HTTP_VERB = 'PUT';
            this.POST_HTTP_VERB = 'POST';
            this.LOCK_HTTP_VERB = 'LOCK';
        ...
        Client.prototype.isCompleted = function (request) {
        ...
        Client.prototype.Sha256ROTR = function (n, x) { return (x >>> n) | (x << (32 - n)); };
        Client.prototype.Sha256Sigma0 = function (x) { return this.Sha256ROTR(2, x) ^ this.Sha256ROTR(13, x) ^ this.Sha256ROTR(22, x); };
        Client.prototype.Sha256Sigma1 = function (x) { return this.Sha256ROTR(6, x) ^ this.Sha256ROTR(11, x) ^ this.Sha256ROTR(25, x); };
        Client.prototype.Sha256sigma0 = function (x) { return this.Sha256ROTR(7, x) ^ this.Sha256ROTR(18, x) ^ (x >>> 3); };
        Client.prototype.Sha256sigma1 = function (x) { return this.Sha256ROTR(17, x) ^ this.Sha256ROTR(19, x) ^ (x >>> 10); };
        Client.prototype.Sha256Ch = function (x, y, z) { return (x & y) ^ (~x & z); };
        Client.prototype.Sha256Maj = function (x, y, z) { return (x & y) ^ (x & z) ^ (y & z); };
        ...
        Client.prototype.httpRequest = function (url, httpVerb, sendData, callback, asynchronous) {
            var _this = this;
            var XHR = getXhr();
        ...
        Client.prototype.onGotSession = function (status, response) {
            var This = this, i, data;
            if (status !== 200) {
        ...
        Client.prototype.onGotNonce = function (status, response) {
            var This = this;
            if (status !== 200) {
                if (This.LoginCallback instanceof Function) {
                    This.LoginCallback(false, status, response);
        ...
        Client.prototype.nowAsMormotTime = function () {
            var s, d = new Date(), mTime = '';
        ...
        Client.prototype.onGotTimestamp = function (status, response) {
            var This = this;
            if (status !== 200) {
                if (This.LoginCallback instanceof Function) {
                    This.LoginCallback(false, status, response);
        ...
        Client.prototype.onLogout = function (status, response) {
            var This = this, success = (status >= 200 && status < 300);
            This.loggedIn = false;
        ...
        Client.prototype.logIn = function (server, root, username, password, callback, hashedPassword, passedOptions) {
        ...
        Client.prototype.logout = function (callbackFunc) {
            ...
            if (This.loggedIn === true) {
                if (callbackFunc) {
                    This.LogoutCallback = callbackFunc;
                }
                ;
        ...
        Client.prototype.logoutSync = function () {
            var This = this, status = This.loggedIn ? This.httpRequest(This.ServerURL + "/" + This.signUrl(This.Root + "/Auth?UserName=" + This.User + "&Session=" + This.SessionID), This.GET_HTTP_VERB, null, null, false) : 400, success = (status >= 200 && status < 300);
            if (success) {
                This.clearSession();
            }
            return success;
        ...
        Client.prototype.retrieveRecordWhere = function (table, select, where, callback) {
            var This = this;
            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + table + '?select=' + select + '&where=' + where), This.GET_HTTP_VERB, null, function (HTTPstatus, response) {
        ...
        Client.prototype.retrieveRecord = function (table, id, forUpdate, callback) {
            var This = this;
            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + table + "/" + id), forUpdate ? This.GET_HTTP_VERB : This.LOCK_HTTP_VERB, null, function (HTTPstatus, response) {
                var obj = JSON.parse(response) || {};
                callback(HTTPstatus, obj);
            });
        };
        Client.prototype.addRecord = function (table, record, callback) {
            var This = this, pos, recordID;
            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + table), This.POST_HTTP_VERB, JSON.stringify(record || {}), function (HTTPstatus, response) {
                pos = response.lastIndexOf('/');
                recordID = parseInt(response.substr(pos + 1), 10);
                callback(HTTPstatus, table, recordID);
            });
        };
        Client.prototype.updateRecord = function (table, record, callback) {
            var This = this;
            if (!record.ID) {
                callback(400, '{"ErrorCode":400,"ErrorText":"Bad Request"}');
            }
            else {
                This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + table + '/' + record.ID), This.PUT_HTTP_VERB, JSON.stringify(record || {}), callback);
            }
        };
        Client.prototype.get = function (url, callback, passedOptions) {
            var This = this, obj;
            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + url), This.GET_HTTP_VERB, null, function (HTTPstatus, response) {
                if ((HTTPstatus === 403) && (This.RetryLogin)) {
                    This.RetryLogin = false; //retry only once
                    This.logIn(This.ServerURL, This.Root, This.User, This.PasswordHashHexa, function (success, HTTPstatus, response) {
                        if (success) {
                            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + url), This.GET_HTTP_VERB, null, function (HTTPstatus, response) {
        ...
        Client.prototype.post = function (url, postedData, callback, passedOptions) {
            var This = this;
            This.httpRequest(This.ServerURL + '/' + This.signUrl(This.Root + '/' + url), This.POST_HTTP_VERB, postedData, function (HTTPstatus, response) {
                if ((HTTPstatus === 403) && (This.RetryLogin)) {
                    This.RetryLogin = false; //retry only once
                    This.logIn(This.ServerURL, This.Root, This.User, This.PasswordHashHexa, function (success, HTTPstatus, response) {
                        if (success) {
